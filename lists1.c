...
/**
 * list_to_strings -to return an array of strgs of the list->str
...
/**
 * node_starts_with - to returns node whose strg starts with prefix
 * @node: the pointer to list head
 * @prefix: the strg to match
...
/**
 * get_node_index - to gets the index of a node
